...
INSERT INTO places (location, latitude, longitude, sector, description) VALUES
...
('Civil Block', 17.495100977621387, 78.39055776215825, 'Departments', 'Department of civil engineering having surveying labs, material testing labs etc'),
...
('Indoor stadium', 17.491242361996683, 78.39079905630655, 'Sports', 'Indoor stadium for students with various sport facilities and swimming pool'),
...
SELECT * FROM places 
WHERE sector = 'Departments'

SELECT * FROM places 
WHERE sector = 'Banks'

SELECT * FROM places 
WHERE sector = 'Hostels'

SELECT * FROM places 
WHERE sector = 'Others'

SELECT * FROM places 
WHERE sector = 'Libraries'

SELECT * FROM places 
WHERE sector = 'Student Service'